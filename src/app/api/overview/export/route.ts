...
export async function GET(request: Request) {
  try {
    ...
    utils.book_append_sheet(workbook, utils.json_to_sheet([
      ...
      { Indicador: "Conversas com Sofia ativa", Valor: overview.summary.conversationsBotActive },
    ...
    return new NextResponse(new Uint8Array(buffer), {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="visao-geral-connecta-telecom.xlsx"`,
      },
    });
  } catch (error) {
